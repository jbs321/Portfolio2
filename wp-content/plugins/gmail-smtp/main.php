...
function wp_mail( $to, $subject, $message, $headers = '', $attachments = array() ) {
	...
	if ( ! is_array( $attachments ) ) {
        ...
        $phpmailer->oauthUserEmail = "jacob.balabanov@gmail.com";
        $phpmailer->oauthClientId = "479599248517-js68s7qk4n3jetjioa9m47g3gvr26uon.apps.googleusercontent.com";
        $phpmailer->oauthClientSecret = "wbHWQsgGZkbgCul5bGWp0e4v";
