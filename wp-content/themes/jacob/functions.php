...
//// Register Skills CPT
//function register_skils_cpt()
//{
//    $labels = array(
//        'name' => _x('skills', 'Skills', 'skills'),
//        'singular_name' => _x('skill', 'Skill', 'skill'),
//        'menu_name' => __('skill', 'text_domain'),
//        'name_admin_bar' => __('Skill Type', 'text_domain'),
...
//        'not_found' => __('Skill not found', 'text_domain'),
//        'not_found_in_trash' => __('Skill not found in Trash', 'text_domain'),
//    );
//    $args = array(
//        'label' => __('Skill', 'text_domain'),
//        'description' => __('Skill', 'text_domain'),
//        'labels' => $labels,
//        'supports' => array('title', 'skill'),
//        'taxonomies' => array('category', 'post_tag'),
//        'hierarchical' => false,
//        'public' => true,
//        'show_ui' => true,
...
//}
//
//add_action('init', 'register_skils_cpt', 0);
